...
'''
This file visualises the behaviour of all boids in a population given the same input.
'''
...
# Example paths of different populations that exhibit different bahaviour
example_paths = [
         'logs\example1\pop_info_steps500_pop25_gens50_cot=none_mr1e-02_ms1e-02_ts1.npz',
         'logs\example2\pop_info_steps500_pop25_gens50_cot=single_point_mr1e-01_ms1e-02_ts5.npz',
         'logs\example3\pop_info_steps500_pop25_gens50_cot=uniform_mr2e-01_ms2e-01_ts2.npz',
         'logs\example4\pop_info_steps500_pop25_gens50_cot=single_point_mr2e-01_ms4e-01_ts2.npz',
         'logs\example5\pop_info_steps500_pop25_gens50_cot=mean_mr4e-01_ms2e-01_ts5.npz'
         ]

# Test out the different behaviours of the example paths by changing the index
# To use your path paste the file path that ends with npz here
filepath = example_paths[1]
